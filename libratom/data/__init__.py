...
with (
    as_file(files(__name__).joinpath("media_types.json")) as media_types_file,
    open(media_types_file, "r", encoding="utf8", errors="strict") as fp,
):
...
with (
    as_file(files(__name__).joinpath("eml_dump_input.schema.json")) as schema_file,
    open(schema_file, "r", encoding="utf8", errors="strict") as schema_fp,
):
